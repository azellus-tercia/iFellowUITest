...
public final class CustomAllureSelenide implements LogEventListener {
    ...
    public CustomAllureSelenide includeSelenideSteps(final boolean includeSelenideSteps) {
        this.includeSelenideLocatorsSteps = includeSelenideSteps;
        return this;
    }

    public CustomAllureSelenide enableLogs(final LogType logType, final Level logLevel) {
        logTypesToSave.put(logType, logLevel);
        return this;
    }

    public CustomAllureSelenide disableLogs(final LogType logType) {
